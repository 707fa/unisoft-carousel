...
params:
  ...
  - name: fields.wallet_id
    type: String
    required: true
    desc: "Receiver wallet id."
  - name: fields.debit_ext_id
    type: String
    required: true
    desc: "Transfer debit ext id."
---

## 8.9 Transfer Create Wallet to Card

### Wallet To Card Request
...
> Uzcard payment example (`ext_id: "uzcard_test_118"`), reproduced here as-is.
